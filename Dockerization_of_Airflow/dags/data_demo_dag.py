...
# creating a new dag
with DAG('dataflow_process_dag', default_args=default_args, schedule_interval='0 0 * * 2', max_active_runs=1) as dag:
    ...
    data_report1 = PythonOperator(task_id='data_report', python_callable=data_report,
                             op_kwargs={'fig_path': fig_path}, dag=dag)
    ...
    read_table >> data_report1
    data_report1 >> [plots, train_test]
    train_test >> model_run
